...
FaceMenu = {
    ...
    loadFace: function(faceIndex) {
        ...
        if (data) {
			...
			//加入到表情容器中
            container.html(htmlCode);
            //htmlCode = pageIndex + 1 + "/" + pageCount + "<a href='javascript:;' onclick='FaceMenu.ourFaceConfig.pageIndex--;FaceMenu.loadFace(FaceMenu.currFaceIndex);'>&lt;&lt;上一页</a><a href='javascript:;' onclick='FaceMenu.ourFaceConfig.pageIndex++;FaceMenu.loadFace(FaceMenu.currFaceIndex);'>下一页&gt;&gt;</a>";
            //pageBar.html(htmlCode);
        }
...
function get139OldFaceConfigData(){
    var list = [];
    var titleList = ["微笑", "礼物", "白眼", "调皮", "发呆", "眨眼", "流汗", "惊呆", "大哭", "脸红", "迷倒", "酷", "发怒", "睡着了", "撇嘴", "打电话", "听歌", "思考", "滴汗", "嘘", "捂嘴", "打哈欠", "圣诞", "天使", "咖啡", "炸弹", "信封", "礼物", "太阳", "月亮", "男人", "女人", "穿心", "心碎", "玫瑰", "凋谢", "强", "弱", "差劲", "胜利"];
    var template = "<a title='{title}' href='javascript:;'\
